...
''' <summary>
''' tables used -party,godown,bill,gst,rent,group,gdtrans,clgdwn
''' this is form to accept inputs from user to view/print tenant detail
...
Public Class FrmPartyDetail
    ...
    Private Sub ShowData()
        ''''''''show tenat details in data grid view uing party table
        Try
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        ''''''assign p_code value from current datagrid row to tenant code text box when double click the datagrid
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If IsFileOpen(New FileInfo(Application.StartupPath & "\Reports\" & TextBox5.Text & ".csv")) = True Then
            ...
            '''''''''''''''''start - tenant detail about residential address,phone number, office address, office phone number,email id, gstin number, contact person etc.
            ...
            ''''''''''''''''end - tenant detail about residential address,phone number, office address, office phone number,email id, gstin number, contact person etc.
            ''''''''start - details of godown allotted to the tenant----------------
            ...
            Do While chkrs2.EOF = False
                If chkrs2.Fields(1).Value = TextBox1.Text Then
                    ...
                    End If
                    If (chkrs2.Fields(10).Value.Equals("C")) Then    ''''''''''''''''''godown is in use
                        ...
                        End If
                        ''''''''end - details of godown allotted to the tenant----------------

                        ''''''''''''''advance detail from advances table, if received before 30-06-2018 -start---------
                        ...
                        Loop
                        chkrs77.Close()
                        ''''''''''''''advance detail from advances table, if received before 30-06-2018 -end---------
                        ...
                        ''''''''''''''''''''payment details end
                    Else
                        ''''''''''''''''checking in godown transfer table start
                        ...
                        Loop
                        chkrs4.Close()
                        ''''''''''''''''checking in godown transfer table end 



                        '''''''''''''''''''checking in godown close /suspend tabel start
                        chkrs5.Open("SELECT * FROM CLGDWN WHERE [close_suspend]<>'C' and [GROUP]='" & chkrs2.Fields(0).Value & "' and GODWN_NO='" & chkrs2.Fields(3).Value & "' and P_CODE ='" & TextBox1.Text & "' order by [GROUP],GODWN_NO,P_CODE DESC", xcon)
                        ...
                        Loop
                        chkrs5.Close()
                        '''''''''''''''''''checking in godown close /suspend tabel end
                    End If


                End If

                ''''''''''''''''''outstanding details start
                Dim otst As Double = 0
                Dim prvdt As String = ""
                If IsDBNull(chkrs2.Fields(21).Value) Then   'outstanding - outst from godown table
                Else
                ...
                ''''''''''''''''''outstanding details end
            Loop
            chkrs2.Close()   ''''''godown table
            chkrs1.Close()    '''party table
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        '''''report print - same logic as button1_click (report view)
        If (TextBox1.Text = "") Then
            MsgBox("Please enter Tenant code .......")
            TextBox1.Focus()
            Exit Sub
