''' <summary>
''' report view form - tenant master list
''' In this module we are displaying .dat file in reachtextbox
''' </summary>
Public Class FrmTenantListView
    Dim formloaded As Boolean = False
    Private checkPrint As Integer
    Private Sub FrmTenantListView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FrmTenantListView_Move(sender As Object, e As EventArgs) Handles Me.Move
