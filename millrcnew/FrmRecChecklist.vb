                        ...
                        If HSNCD.Equals(HSN) Then
                            ...
                            If CheckBox1.Checked Then
                                If chkrs1.Fields(6).Value = True Then
                                    ...
                                    Print(fnumm, GetStringToPrint(17, chkrs1.Fields(10).Value, "S") & "," & GetStringToPrint(17, IIf(chkrs1.Fields(7).Value.Equals("C"), "", "  " & chkrs1.Fields(11).Value), "S") & "," & GetStringToPrint(13, " ", "N") & "," & GetStringToPrint(13, "", "N") & "," & GetStringToPrint(12, "", "S") & "," & GetStringToPrint(7, "", "N") & "," & GetStringToPrint(13, "", "N") & "," & GetStringToPrint(50, chkrs1.Fields(8).Value, "S") & "," & GetStringToPrint(33, chkrs1.Fields(9).Value, "S") & vbNewLine)
                                    xline = xline + 1
