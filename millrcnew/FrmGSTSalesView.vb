Public Class FrmGSTSalesView
    ...
    Private Sub FrmGSTSalesView_Move(sender As Object, e As EventArgs) Handles Me.Move
        If formloaded Then
    ...
    Private Sub FrmGSTSalesView_Load(sender As Object, e As EventArgs) Handles Me.Load
