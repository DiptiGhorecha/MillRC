Public Class FrmGSTAdvView
    Dim formloaded As Boolean = False
    Private checkPrint As Integer

    Private Sub FrmGSTAdvView_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FrmGSTAdvView_Move(sender As Object, e As EventArgs) Handles Me.Move
        If formloaded Then
